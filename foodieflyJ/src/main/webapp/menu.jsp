...
<%@ page import="java.util.List, com.tap.Models.Menu, com.tap.Models.Restaurant" %>
...
<body>
    ...
    <h2 id="menu">Menu</h2>
        <div class="menu-grid">
            ...
            <div class="menu-card">
                <img src="<%= m.getImagePath() %>" alt="Veg Biryani" class="food-image">
                <div class="card-content">
                    <div class="item-details">
                        ...
                        <div class="item-rating">★ <%= m.getRatings() %></div>
