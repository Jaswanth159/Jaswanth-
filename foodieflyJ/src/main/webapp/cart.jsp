<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="com.tap.Models.Cart,com.tap.Models.CartItem,com.tap.Models.Restaurant" %>
...
<body>
    ...
    %>
			 ...
			 <div class="empty-cart-container">
		        ...
		        <a href="homePage" class="browse-restaurants-btn">
    ...
    <div class="cart-page-container">
        <div class="cart-container">
            ...
            <div class="cart-buttons">
                <button class="add-more-btn" onclick="window.location.href='menuServlet?restaurantId=<%=session.getAttribute("restaurantId")%>'">Add More Items</button>
                <form action="CartServlet" method="post">
                <input type="submit" value="Clear Cart" name="action" class="checkout-btn">
